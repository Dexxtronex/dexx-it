...
<body>
    ...
    <body>
            ...
            ?>
                ...
                <div class="container">
                    <?php
                        require_once  'view/secciones/secciones/quienes_somos.php'?>
                </div>
                <div class="container">
                    <?php
                        require_once  'view/secciones/secciones/quienes_somos_suscribete.php'?>
                </div>
                </main>         
            <?php
            require_once  'view/secciones/pie.php';
            ?>
    </body>
</html>
