...
<html>
    <head>
    <title>Dexx-Veteri-Contactos</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Sistema generico de Sitio Web Veterinaría-Peluquería, se encarga de disponer un sitio el cual brinde reservaciones, control de citas, control médico hacia la mascota.">
    ...
    <body>
            ...
            ?>
                ...
                <div class="container">
                    <?php
                        require_once  '../secciones/contacto_gps.php'
                    ?>
                </div>
                <div class="container">
                    <?php
                        require_once  '../secciones/mensajeria.php'
                    ?>
                </div>
                </main>         
            <?php
