...
<head>
    ...
    <body>
            ...
            if(isset($_SESSION['user'])){
                $user = $_SESSION['user'];
               if($user == "veterinario" || $user == "admin"){
                echo '
       ...
       ?>
                ...
                <div class="container">
                    <?php
                        require_once  '../secciones/informacion_veterinaria.php'
                    ?>
                </div>
                <div class="container">
                    <?php
                        require_once  '../secciones/mensajeria_veterinaria.php'
                    ?>
                </div>
                </main>         
            <?php
